...
{
   list_LD[cur_LD_pos] = val; cur_LD_pos++;
}
...
{
   list_LD[cur_LD_pos-1] = (list_LD[cur_LD_pos-1] & val);
}
...
void exec_ald()         
{
   list_LD[cur_LD_pos-2] = (list_LD[cur_LD_pos-1]) & (list_LD[cur_LD_pos-2]); cur_LD_pos--;
}
